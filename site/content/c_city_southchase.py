...
HUB = page(
    ...
    "".join([
        ...
        sec("Permits, HOA paperwork and what to line up before a crew arrives",
            ...
            + f"<p>Southchase also isn't run by one master homeowners association. County HOA filings show a string of separate parcel-level boards, several chartered around 1989 through the early 1990s as each phase was built out, plus the independently managed Parcel 6 community (" + ext("https://florida-hoa.net/fhhoa_list.php?mastertable=fhtitle&masterkey1=N33740", "Florida-HOA.net's Southchase association listings") + "). That means the architectural-review process for a Southchase yard depends on which phase the address sits in, not a single Southchase-wide rulebook; {a('/laws/hoa-rules/', 'what Florida law lets any of them restrict')} still comes down to F.S. 720.3045, and {a('/tools/hoa-packet-checklist/', 'our HOA packet checklist')} covers what to submit either way.</p>"),
