...
def polk():
    body = "".join([
        ...
        sec("Checking your parcel",
            f"<p>Polk County's northern edge, around Davenport, Haines City and Auburndale, is where most of our jobs sit, and a handful of those addresses are inside a city limit rather than unincorporated county land. Confirm the taxing jurisdiction on the {ext(POLK_PA[1], POLK_PA[0])} before assuming which building department to call.</p>"),
        sec("Water utility and irrigation",
