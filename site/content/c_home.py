...
def get_pages():
    ...
    body = "".join([
        ...
        sec("Turf or sod? A quick way to decide",
            ...
            + f"<p>Plug your own mowing and water bills into the {a('/tools/turf-vs-sod/', 'turf vs. sod calculator')}, read {post('is-artificial-turf-worth-it-in-florida', 'whether turf is worth it in Florida')}, or compare it with {a('/compare/artificial-turf-vs-st-augustine-zoysia-bahia/', 'St. Augustine, Zoysia and Bahia')} head to head.</p>"),
    ...
    faqs = [
        ...
        faq("Do you fix turf that a different crew put in?", "Yes. Seams that opened, edges that lifted, wrinkles, low spots and melted patches from window reflection can usually be repaired without replacing the lawn. We'll tell you if the base is the real problem."),
