    ...
    body = "".join([
        ...
        sec("Who handles turf permits in Polk County",
            ...
            + table("Who reviews a synthetic turf job in Polk County",
                    ...
                    "Checked against the county's published code September 2026. Every city row links to the page where that town’s permit office was checked; the county code was read September 2026. Call the office before starting")),
